...
const FeaturedProjects = () => {
            ...
            all.push(
                <div className={classes.smallProject} key={allProjects[i].name}>
                    ...
                    <div className={classes.iButton}>
                        <p>
                            {allProjects[i].description.split('.')[0]}
                        </p>
                    </div>
                </div>
            )
    ...
    const displayProjectsChangeHandler = () => {
        if(displayProjects.length===6) {
            setDisplayProjects([...displayProjects, ...allDisplayProjects.slice(6,9)]);
        } else {
        ...
        <div id="featuredProjects" className={`${classes.outer} ${(lightMode && classes.light)}`}>
            <div className={classes.featuredProjects}>
                ...
                <div id="otherProjects" className={classes.otherProjects}>
                    ...
                    <Link to='/projects' style={{ textDecoration: 'underline', marginBottom: '20px' }}><p>View Complete Archive</p></Link>
                    <div className={classes.otherProjectsInner}>
                        {displayProjects}
                    </div>
                    <button className={classes.showMoreButton} onClick={displayProjectsChangeHandler}>Show {displayProjects.length === 6 ? 'More': 'Less'}</button>
                </div>
            </div>
        </div>
    )
